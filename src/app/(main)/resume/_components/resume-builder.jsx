        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="edit">
            <form className='space-y-8' >
              ...
              <div className="space-y-4">
                <h3 className="mt-2 text-lg font-medium">Professional Summary</h3>
                <Controller
                  name="summary"
                  control={control}
                  render={({ field }) => (
              ...
              <div className="space-y-4">
                <h3 className="mt-2 text-lg font-medium">Skills</h3>
                <Controller
                  name="skills"
                  control={control}
                  render={({ field }) => (
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-medium mt-2">Work Experience</h3>
                <Controller
                  name="experience"
                  control={control}
                  render={({ field }) => (
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-medium mt-2">Education</h3>
                <Controller
                  name="education"
                  control={control}
                  render={({ field }) => (
              ...
              <div className="space-y-4">
                <h3 className="mt-2 text-lg font-medium">Projects</h3>
                <Controller
                  name="projects"
                  control={control}
                  render={({ field }) => (
          ...
          <TabsContent value="preview">
            ...
            <div className="border rounder-lg">
